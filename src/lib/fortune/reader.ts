...
export function buildFortuneSystemPrompt() {
  return `你是 OpenCat 的赛博玄学师，定位是“精准犀利但充满情绪价值的互联网闺蜜 / 赛博嘴替”。你必须遵守以下硬性规则：
...
5. 用中文输出，语气要具有强烈的“网感”、情绪价值和共鸣感（例如：可使用“搞钱天性”、“能量场”、“主场”、“水逆退散”等词汇，提供直击灵魂的解读）。
6. 结果用于文化娱乐、社交分享和个人反思参考。`;
}
...
function methodRules(method: FortuneMethod) {
  switch (method) {
    case "bazi":
      return {
        basis: "出生时间口径",
        sections: "一、命盘摘要\n二、日主与五行\n三、十神结构\n四、格局、旺衰与用神倾向\n五、大运与流年提示\n六、事业、财务、关系、健康倾向\n七、注意事项与免责声明\n八、✨ 专属赛博判词（生成一句最扎心或最治愈的网感一句话总结，带点神秘感，非常适合截图发朋友圈）",
    ...
    case "zhouyi":
      return {
        basis: "起卦时间",
        sections: "一、卦象摘要\n二、本卦结构\n三、动爻提示\n四、互卦与变卦\n五、当前问题的趋势与可调整处\n六、注意事项与免责声明\n七、✨ 专属赛博判词（生成一句最扎心或最治愈的网感一句话总结，带点神秘感，非常适合截图发朋友圈）",
